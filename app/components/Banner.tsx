  ...
  return (
    <div className="flex flex-col md:flex-row mt-[100px] relative w-full p-6 md:pt-[100px] md:pr-[142px] md:pb-[100px] md:pl-[100px] items-center gap-4 md:gap-[150px] rounded-[20px] bg-[#00224d] bg-opacity-40">
      ...
      <div className="flex flex-col items-start gap-4 md:gap-[16px] flex-1 z-10">
        <p className="self-stretch text-[var(--foreground-primary)] text-[22px] md:text-[30px] lg:text-[40px] not-italic font-[500] leading-[36px] md:leading-[48px] lg:leading-[60px] uppercase">
          NÂNG CAO TỦ ĐỒ CỦA BẠN
        </p>
        <p className="self-stretch text-[var(--text-color)] text-[16px] md:text-[18px] font-[400] not-italic leading-[24px] md:leading-[27px]">
