...
const AllCollections = () => {
  ...
  return (
    <div>
      ...
      <div className="flex justify-center gap-8 py-8 px-20">
        <Select
          defaultValue="Sắp xếp theo giá"
          onChange={handleSortByPrice}
          className="w-fit text-lg text-yellow-500" // Thêm lớp text-yellow-500
        >
      ...
      {loading ? (
        ...
        >
          <div className=" flex justify-center text-center items-center  rounded-[50px] relative">
            <p className="text-[gold] text-[46px] font-[700] leading-[50px] absolute z-30 font-mono opacity-75">
              ALL
              <br />
              COLLECTIONS
            </p>
            <Image
              ...
              width={0}
              height={0}
              className="h-full w-full rounded-[20px] opacity-10 absolute"
            />
          </div>
